...
def _yysls_rich_parse(base: dict) -> dict:
    ...
    """
    from ...core.recognizer.reference_adapter import parse_rich_base
    return parse_rich_base(base)
...
#
# 匹配的是 OCR 扫描到的词条文本，恒为中文（游戏本身只有中文），
# 不能过 tr()——英文界面下会拿翻译后的英文去匹配中文截屏，永远匹配不上。
