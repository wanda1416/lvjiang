...
> 日期：2026-07-16
> 涉及模块：`lvjiang/core/capture.py`、`lvjiang/core/input.py`、`lvjiang/core/material_recognizer.py`、`lvjiang/equip_parser/parser.py`、`lvjiang/workflows/engine.py`、`lvjiang/ui/run_control.py`、`lvjiang/__main__.py`、`config/base_attrs.yaml`、`config/system/workflows/equip_analysis.wf`
...
- **基础属性品阶推断**：`base_attrs.yaml` 补充 ring/pendant/armor_other/chest 的 purple/blue 品阶数据
...
- `base_attrs.yaml`：补充 ring/pendant/armor_other/chest 的 purple/blue 品阶数据
...
| `config/base_attrs.yaml` | 修改 | 补充 purple/blue 品阶数据 |
